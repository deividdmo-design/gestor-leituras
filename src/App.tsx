        ...
        {currentView === 'library' ? (
          ...
          <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white p-6 rounded-3xl border shadow-sm"><Calendar className="text-blue-600 mb-2"/><p className="text-xs font-bold text-slate-400 uppercase mb-1">Lidos em {currentYear}</p><p className="text-3xl font-black text-slate-900">{analytics.totalLidosAno}</p></div>
